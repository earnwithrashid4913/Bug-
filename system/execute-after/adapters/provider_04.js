...
// =============================================================================
// EXECUTEAFTER — ADAPTER provider_04
// =============================================================================
// Independent adapter for slot provider_04 (config key: execute-after.config.js →
// EXECUTE_AFTER_PROVIDERS.provider_04).
//
// This file is OPTIONAL. It exists so provider_04 can have provider-specific parsing
...
//   2. provider_04 → command:  'Exec4'          (CHANGE COMMAND NAME HERE)
//   3. provider_04 → endpoint: 'https://...'      (PUT YOUR PERMITTED API ENDPOINT HERE)
//   4. provider_04 → modes / queryParam / contract  (only what your API documents)
//
// Only replace parseProviderResponse() below when provider_04 returns a structure
...
/**
 * provider_04 — PROVIDER-SPECIFIC PARSER (UNRESOLVED until you inspect the real API).
 *

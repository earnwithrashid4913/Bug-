...
// =============================================================================
// EXECUTEAFTER — ADAPTER provider_03
// =============================================================================
// Independent adapter for slot provider_03 (config key: execute-after.config.js →
// EXECUTE_AFTER_PROVIDERS.provider_03).
//
// This file is OPTIONAL. It exists so provider_03 can have provider-specific parsing
...
//   2. provider_03 → command:  'Exec3'          (CHANGE COMMAND NAME HERE)
//   3. provider_03 → endpoint: 'https://...'      (PUT YOUR PERMITTED API ENDPOINT HERE)
//   4. provider_03 → modes / queryParam / contract  (only what your API documents)
//
// Only replace parseProviderResponse() below when provider_03 returns a structure
...
/**
 * provider_03 — PROVIDER-SPECIFIC PARSER (UNRESOLVED until you inspect the real API).
 *
